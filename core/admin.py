...
admin.site.register(announced_lga_result)
admin.site.register(announced_pu_result,Announced_pu_results)
admin.site.register(announced_state_result)
admin.site.register(announced_ward_result)
